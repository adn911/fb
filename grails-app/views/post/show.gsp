	...
	<body>
		...
		<div id="show-post" class="content scaffold-show" role="main">
			...
			<ol class="property-list post">
				...
				<g:if test="${postInstance?.likes}">
				<li class="fieldcontain">
					<span id="likes-label" class="property-label"><g:message code="post.likes.label" default="Likes" /></span>
					
						<g:each in="${postInstance.likes}" var="l">
						<span class="property-value" aria-labelledby="likes-label"><g:link controller="like" action="show" id="${l.id}">${l?.encodeAsHTML()}</g:link></span>
						</g:each>
