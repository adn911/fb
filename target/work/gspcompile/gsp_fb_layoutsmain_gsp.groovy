...
class gsp_fb_layoutsmain_gsp extends GroovyPage {
...
createTagBody(2, {->
createTagBody(3, {->
invokeTag('layoutTitle','g',10,['default':("Grails Mini Facebook")],-1)
})
...
printHtmlPart(5)
invokeTag('stylesheet','asset',18,['src':("application.css")],-1)
printHtmlPart(6)
invokeTag('stylesheet','asset',19,['src':("bootstrap.css")],-1)
printHtmlPart(7)
invokeTag('stylesheet','asset',21,['src':("styles.css")],-1)
printHtmlPart(8)
...
createTagBody(1, {->
printHtmlPart(10)
invokeTag('include','g',29,['view':("/templates/_header.gsp")],-1)
printHtmlPart(6)
invokeTag('layoutBody','g',30,[:],-1)
printHtmlPart(11)
invokeTag('include','g',31,['view':("/templates/_footer.gsp")],-1)
printHtmlPart(10)
})
